...
export default function Sandwich(): JSX.Element {
    ...
    function handleAddOnion():void{
        dispatch({ type:'sandwich/addIngredient', payload:' onion' })
    }
...
return(
    <div>
        ...
        <button type="button" onClick={handleAddOnion}>Add onion</button>
        <button type="button" onClick={handleAddSalad}>Add salad</button>
